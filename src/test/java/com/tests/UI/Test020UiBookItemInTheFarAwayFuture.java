...
public class Test020UiBookItemInTheFarAwayFuture extends BaseTest {
    @Steps
    ...
    @Test
    public void test020UiBookItemInTheFarAwayFuture() {
        bookingsFlowSteps.bookItem(10000, 0, 0, 1, 1, 1);
