...
public class Test031UiChangeDefaultBookingLength extends BaseTest {
    @Steps
    ...
    @Test
    public void test031UiChangeDefaultBookingLength() {
        apiCategorySteps.changeDefaultBookingLengthDaysValue(3);
        bookingsFlowSteps.bookItemWithDefaultSetLength();
        ...
        bookingsFlowSteps.checkIfBookingIsPresentOrNotByCheckingDetails(true);
        bookingsFlowSteps.checkIfBookingIsPresentOrNotInTheCalendar(true);
        bookingsFlowSteps.returnAllBookingsOfTheItemsFromSession();
    }
}
