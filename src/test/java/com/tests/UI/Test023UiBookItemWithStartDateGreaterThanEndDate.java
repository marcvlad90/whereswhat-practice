...
public class Test023UiBookItemWithStartDateGreaterThanEndDate extends BaseTest {
    @Steps
    ...
    @Test
    public void test023UiBookItemWithStartDateGreaterThanEndDate() {
        bookingsFlowSteps.bookItem(10, 10, 10, -10, -10, -10);
