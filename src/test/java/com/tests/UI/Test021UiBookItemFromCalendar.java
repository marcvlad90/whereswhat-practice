...
public class Test021UiBookItemFromCalendar extends BaseTest {
    @Steps
    ...
    @Test
    public void test021UiBookItemFromCalendar() {
        bookingsFlowSteps.bookItemFromCalendar(1, 1, 1, 1, 1, 1);
