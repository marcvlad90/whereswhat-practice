...
public class Test035UiImportSameCategoryItemsFromDownloadedCsvTemplate extends BaseTest {
    @Steps
    ...
    @Test
    public void test035UiImportSameCategoryItemsFromDownloadedCsvTemplate() throws Exception {
