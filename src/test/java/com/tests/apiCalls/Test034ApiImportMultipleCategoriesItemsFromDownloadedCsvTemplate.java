...
public class Test034ApiImportMultipleCategoriesItemsFromDownloadedCsvTemplate extends BaseTest {
    @Steps
    ...
    @Test
    public void test034ApiImportMultipleCategoriesItemsFromDownloadedCsvTemplate() throws Exception {
