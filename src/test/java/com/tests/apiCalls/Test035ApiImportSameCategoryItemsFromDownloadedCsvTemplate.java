...
public class Test035ApiImportSameCategoryItemsFromDownloadedCsvTemplate extends BaseTest {
    @Steps
    ...
    @Test
    public void test035ApiImportSameCategoryItemsFromDownloadedCsvTemplate() throws Exception {
