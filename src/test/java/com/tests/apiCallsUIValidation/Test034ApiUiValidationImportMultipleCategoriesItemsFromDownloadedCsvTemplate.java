...
public class Test034ApiUiValidationImportMultipleCategoriesItemsFromDownloadedCsvTemplate extends BaseTest {
    @Steps
    ...
    @Test
    public void test034ApiUiValidationImportMultipleCategoriesItemsFromDownloadedCsvTemplate() throws Exception {
        apiItemSteps.createMultipleItemsFromDownloadedCsvTemplate(items, true);
