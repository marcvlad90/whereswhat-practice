...
public class Test017ApiUiValidationImportItemsInTheSameCategory extends BaseTest {
    @Steps
    ...
    @Test
    public void test017ApiUiValidationImportItemsInTheSameCategory() throws Exception {
