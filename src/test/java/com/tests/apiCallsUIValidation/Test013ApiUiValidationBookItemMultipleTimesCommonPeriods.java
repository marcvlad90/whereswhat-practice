...
public class Test013ApiUiValidationBookItemMultipleTimesCommonPeriods extends BaseTest {
    @Steps
    ...
    @Test
    public void test013ApiUiValidationBookItemMultipleTimesCommonPeriods() {
        apiBookingSteps.bookItem(1, 1, 1, 1, 1, 1);
        bookingsFlowSteps.checkIfBookingIsPresentOrNotByCheckingDetails(true);
        apiBookingSteps.bookTheSameItemInTheSamePeriod();
        bookingsFlowSteps.checkIfBookingIsPresentOrNotByCheckingDetails(true);
        apiBookingSteps.bookItemWithFailure(1, 1, 1, 1, 1, 1);
        bookingsFlowSteps.checkIfBookingIsPresentOrNotByCheckingDetails(false);
        apiBookingSteps.bookItemWithFailure(1, 2, 2, 1, 1, 1);
        bookingsFlowSteps.checkIfBookingIsPresentOrNotByCheckingDetails(false);
        bookingsFlowSteps.checkIfBookingIsPresentOrNotInTheCalendar(false);
        apiBookingSteps.bookItemWithFailure(0, 2, 2, 2, 2, 2);
        bookingsFlowSteps.checkIfBookingIsPresentOrNotByCheckingDetails(false);
        bookingsFlowSteps.checkIfBookingIsPresentOrNotInTheCalendar(false);
    }
}
